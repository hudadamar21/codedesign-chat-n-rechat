<footer data-aos="fade-up" class="main-container mt-20 md:mt-32">
  <div class="bg-primary/5 py-16 px-5 md:p-16 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10 rounded-t-2xl">
    <div class="space-y-4 md:col-span-2">
      ...
      <p class="text-sm md:text-base text-dark/60 pr-10">
    ...
    <div>
      <h2 class="text-base md:text-lg font-medium mb-3 md:mb-4">Sitemap</h2>
      <div class="text-dark/60 space-y-3 text-sm md:text-base">
        <a href="#beranda" class="block font-semibold hover:underline">Beranda</a>
        <a href="#fitur" class="block font-semibold hover:underline">Fitur-fitur</a>
        <a href="#teknologi" class="block font-semibold hover:underline">Teknologi</a>
        <a href="#faq" class="block font-semibold hover:underline">FAQ</a>
        <a href="#download" class="block font-semibold hover:underline">Download</a>
      </div>
    </div>
    <div>
